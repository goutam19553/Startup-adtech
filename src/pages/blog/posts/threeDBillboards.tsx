...
const ThreeDBillboards = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-800 via-gray-900 to-gray-900 text-gray-100">
      <Helmet>
        <title>3D Billboards in India | The Ad Project's Outdoor Revolution</title>
        <meta
          name="description"
          content="Discover how The Ad Project is transforming Indian cities with immersive 3D billboards that captivate audiences and redefine physical advertising."
        />
        <meta
          name="keywords"
          content="3D billboards India, The Ad Project, outdoor advertising, immersive advertising, digital hoardings, brand engagement, AR OOH ads"
        />
        <meta property="og:title" content="How 3D Billboards Are Revolutionizing Brand Engagement in 2025" />
        <meta
          property="og:description"
          content="Explore how The Ad Project is bringing India's advertising landscape to life with cutting-edge 3D billboard technology."
        />
          ...
          {`
            {
              ...
              "image": "https://adproject.in/3d.gif",
              "author": {
                "@type": "Organization",
                "name": "The Ad Project"
              },
